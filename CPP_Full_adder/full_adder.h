...
#define TENS_ADD(a, b, c, d) XCONCAT(HADD3_##a##_##b##_##c, d)

#define XTENS_ADD(a, b, c, d) TENS_ADD(a, b, c, d)

#define ADD_LONG(a1, a2, b1, b2) a1##a2 + b1##b2 = XCONCAT(XCARRY3(a1, b1, CARRY(a2, b2)), XTENS_ADD(a1, b1, CARRY(a2, b2), HALF_ADD(a2, b2)))

#define ADD_SHORT(a, b) a + b = XCONCAT(CARRY(a, b), HALF_ADD(a, b))

#define ADD_LONGER(a1, b1, a2, b2, a3, b3, a4, b4, a5, b5) a1##a2##a3##a4##a5 + b1##b2##b3##b4##b5 = XCONCAT(XCARRY3(a1, b1, XCARRY3(a2, b2, XCARRY3(a3, b3, XCARRY3(a4, b4, CARRY(a5, b5))))), XCONCAT(XHALF_ADD3(a1, b1, XCARRY3(a2, b2, XCARRY3(a3, b3, XCARRY3(a4, b4, CARRY(a5, b5))))), XCONCAT(XHALF_ADD3(a2, b2, XCARRY3(a3, b3, XCARRY3(a4, b4, CARRY(a5, b5)))), XCONCAT(XHALF_ADD3(a3, b3, XCARRY3(a4, b4, CARRY(a5, b5))), XCONCAT(XHALF_ADD3(a4, b4, CARRY(a5, b5)), HALF_ADD(a5, b5))))))

ADD_SHORT(9, 9)
ADD_LONG(9, 9, 9, 9)
ADD_LONG(9, 9, 0, 9)
ADD_LONGER(0,9,0,9,0,9,0,9,1,9)
ADD_LONGER(9,9,9,9,9,9,9,9,9,9)
